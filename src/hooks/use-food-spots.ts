...
import { useApiDelete, useApiGet, useApiPatch, useApiPost } from "./use-api";
...
export function useUpdateFoodSpot(id: string) {
  return useApiPatch<ApiResponse<FoodSpot>, UpdateFoodSpotRequest>(
    `/foodspots/${id}`
  );
}
